...
export function getMetadata(target) {
  return Reflect.getMetadataKeys(target).reduce(function (obj, key) {
    obj[key] = Reflect.getMetadata(key, target);
    return obj;
  }, {});
}
export function copyMetadata(from, to) {
  var _iterator = _createForOfIteratorHelper(Reflect.getMetadataKeys(from)),
      _step;
