...
export declare type InputText = string | any;
...
export declare enum IconsConst {
    X = "x",
    Y = "y",
    W = "w",
    H = "h",
...
export declare type radiusArr = InputText[];
...
export declare type ElementType = string | React.ReactElement<any>;
export declare type Compare = (value: string, option: SelectOption) => boolean;
...
export declare type OptionCompare = (option: SelectOption) => boolean;
