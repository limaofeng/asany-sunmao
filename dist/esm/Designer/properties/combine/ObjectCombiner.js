...
function ObjectCombiner(props) {
  var className = props.className,
      value = props.value,
      onChange = props.onChange;
  var sunmao = useSunmao();
  var fields = props.fields.map(function (item) {
  ...
  var handleValuesChange = function handleValuesChange(_, allValues) {
  ...
  return /*#__PURE__*/_jsx(Form, {
    ...
    children: fields.filter(visibleFilter(props.value)).map(function (item) {
      var _ref = item.renderer,
      ...
      return /*#__PURE__*/_jsx(Form.Item, {
        className: "object-combiner-field-".concat(item.name),
        label: lable,
        name: item.name,
...
export default /*#__PURE__*/React.memo(ObjectCombiner);